...
function MatchList({ schedule }) {
    ...
    const { items, homeOptions, awayOptions, tournamentOptions } =
        useMemo(() => {
            const items = groups
                .map((group) => ({
                    ...group,
    ...
    const columns = [
        {
            ...
            sorter: (a, b) =>
                a.match?.tournament?.en?.localeCompare(b.match?.tournament?.en),
            ...getColumnSearchProps((record) => record.match?.tournament?.en, {
        ...
        },
        {
            ...
            sorter: (a, b) =>
                (a.match?.team1?.en || '').localeCompare(b.match?.team1?.en),
            ...getColumnSearchProps((record) => record.match?.team1?.en, {
                options: homeOptions,
            }),
        },
        {
            ...
            sorter: (a, b) =>
                (a.match?.team2?.en || '').localeCompare(b.match?.team2?.en),
            ...getColumnSearchProps((record) => record.match?.team2?.en, {
                options: awayOptions,
            }),
        },
        {
